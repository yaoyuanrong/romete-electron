...
try {
  if(process.platform == 'darwin') {
    autoUpdater.setFeedURL('http://192.168.152.7:33855/darwin?version=' + app.getVersion())
  } else {
    autoUpdater.setFeedURL('http://192.168.152.7:33855/win32?version=' + app.getVersion())
  }
